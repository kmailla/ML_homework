...
class ModelTestCase(unittest.TestCase):
    ...
    def test_train_data_with_malformed_input(self):
        self.assertRaises(ValueError, lambda: m.load_train_data(FOLDER + '/test_data/malformed_training_data.csv'))

    def test_train_data(self):
        x, y = m.load_train_data(FOLDER + '/test_data/correct_training_data.csv')
